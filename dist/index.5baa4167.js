...
const mapTemplate = function() {
    ...
    // Normal view
    if (button_1.classList.contains("hidden-button")) L.tileLayer("https://{s}.tile.openstreetmap.jp/{z}/{x}/{y}.png", {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map);
    // Satellite view
    if (button_2.classList.contains("hidden-button")) L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", {
...
const addMarker = function(lat, lng, flyTo = true) {
    ...
    if (flyTo) // map.flyTo([lat, lng], map._zoom, {
    //   duration: 4,
    //   easeLinearity: 0.5,
    // });
    map.flyTo([
...
},{}]},["euTuy","igcvL"], "igcvL", "parcelRequire766b")
